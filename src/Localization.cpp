...
namespace ScreenshotLightingAssistant::Localization
{
    namespace
    {
        ...
        { "登録の保存先 (?) / 0.2.0", "Storage location / 0.2.0" },
        ...
        { "常用フェイスライトの設定を開きます。機能とプレイヤーライトがONのとき橙色になります。", "Open persistent face-light settings. The button is amber when both the feature and player light are on." },
        { "常用フェイスライト###sla_persistent_face", "Persistent Face Light###sla_persistent_face" },
        { "常用フェイスライト機能を使用", "Enable persistent face-light feature" },
        { "機能OFF：ホットキーは反応しません。", "Feature OFF: hotkeys are ignored." },
        { "撮影用フェイスライトを一時的に使用中です。撮影を止めると常用設定へ戻ります。", "The photography face light is temporarily in use. Stopping photography restores the persistent settings." },
        { "待機：プレイヤーライトはOFFです。", "Waiting: the player light is off." },
        { "待機：強さが0です。", "Waiting: intensity is zero." },
        { "ON：プレイヤーへ追従しています。", "ON: Following the player." },
        { "待機：ロード中、または頭を取得できません。", "Waiting: loading, or the head is unavailable." },
        { "強さ##persistent", "Intensity##persistent" },
        { "光の範囲##persistent", "Range##persistent" },
        { "上下 (+上)##persistent", "Height (+up)##persistent" },
        { "キーボード：%s", "Keyboard: %s" },
        { "ゲームパッド（0.6秒長押し）：%s", "Gamepad (hold 0.6 sec): %s" },
        { "未設定", "Unassigned" },
        { "登録するキーを押してください。Escでキャンセルします。", "Press the key to assign. Press Esc to cancel." },
        { "登録するゲームパッドボタンを押してください。Escでキャンセルします。", "Press the gamepad button to assign. Press Esc to cancel." },
        { "変更##persistent_keyboard", "Change##persistent_keyboard" },
        { "解除##persistent_keyboard", "Clear##persistent_keyboard" },
        { "キャンセル##persistent_keyboard", "Cancel##persistent_keyboard" },
        { "変更##persistent_gamepad", "Change##persistent_gamepad" },
        { "解除##persistent_gamepad", "Clear##persistent_gamepad" },
        { "キャンセル##persistent_gamepad", "Cancel##persistent_gamepad" },
        { "変更", "Change" },
        { "解除", "Clear" },
        { "白色・影なしのプレイヤー専用ライトです。撮影ライトとは別に使え、ロードや場所移動の完了後に自動で戻ります。ゲームのセーブデータには保存しません。", "A white, shadowless player-only light. It works independently from photography lighting and restores automatically after loading or changing location. It does not write to the game save." },
        { "常用フェイスライト設定を読み込めません。元のファイルは保持しています。", "Cannot read persistent face-light settings. The original file is kept." },
        { "常用フェイスライト設定を保存できません。この起動中だけ変更します。", "Cannot save persistent face-light settings. Changes apply only to this session." },
